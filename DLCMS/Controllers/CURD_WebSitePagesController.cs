...
namespace DLCMS.Controllers
{
    ...
    public class CURD_WebSitePagesController : BaseController
    {
        ...
        [ValidateInput(false)]
        public ActionResult Create([Bind(Include="Name,Department,Sub_Department,Keywords,Title,Description,Text,Sub_Sub_Department,Filename,VideoId")] dlwebclasses.Website_Pages website_pages,string Sub_Sub_Sub_Department)
        {
            using (var _website_PagesServices = new dlwebclasses.Website_PagesServices())
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    int dup_id;
                    _website_PagesServices.Add(website_pages);
                    _website_PagesServices.SaveChanges();
        ...
        public ActionResult Edit(int ID, string Name, string Text, string Title, string Description, string Keywords, string Department, string AltTagIng1, string AltTagIng2, string AltTagIng3, string AltTagIng4, string AltTagIng5, string AltTagIng6, string AltTagIng7, string VideoId)
        {
            using (var _website_PagesServices = new dlwebclasses.Website_PagesServices())
            {
                var WP = new dlwebclasses.Website_Pages();
                WP = _website_PagesServices.FindById(ID);
                WP.Text = Text;
                WP.Name = Name;
                ...
                _website_PagesServices.Update(WP);
                _website_PagesServices.SaveChanges();
