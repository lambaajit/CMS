    ...
    public class HomePage
    {
        ...
        public HomePage(HomePagetype htype = HomePagetype.Main)
        {
            ...
            if (htype == HomePagetype.Main)
            {
                ...
                _NewContent.AppendLine("                <p>We serve clients in over 25 areas of law from offices throughout London and in most of the major cities across England and Wales. Our motto and aim is to ‘give people a voice’ and we strive to achieve the best possible outcome for you through high-quality legal representation. </p>");
                _NewContent.AppendLine("                <p>&nbsp;</p>");
                _NewContent.AppendLine("                <p>We care about your wellbeing and are committed to providing the best possible service to you in the most considerate and careful manner. As the largest provider of publicly funded (legal aid) services in the UK we have specialist solicitors in: Family and Child Care, Crime and Fraud, Civil Liberties and Human Rights, Housing, Immigration, Litigation, Mental Health, Personal Injury, Professional Negligence, Professional Regulation and Public Law. </p>");
                _NewContent.AppendLine("                <p>&nbsp;</p>");
                ...
                _NewContent.AppendLine("                <p>&nbsp;</p>");
                _NewContent.AppendLine("                <p>When you come to Duncan Lewis you come to a prominent and reputable national law firm with over 350 qualified solicitors and consultants (most of whom are Law Society Panel accredited or equivalent), and over 300 trainee solicitors, caseworkers, legal executives and support staff. They are all willing to take the time to listen to your problem, evaluate it correctly in terms of the law and where possible to speak out on your behalf in an attempt to present your point of view in the best light and achieve legal remedies which address your problem.</p>");
                _NewContent.AppendLine("                <p>&nbsp;</p>");
                _NewContent.AppendLine("                <p>We hold industry quality marks to evidence that we are a law firm that you can trust. The firm has held the Law Society Lexcel Excellence in Practice Management and Client Care accreditation since 1999 and was the first firm in the UK to achieve the Investors in People Gold Standard quality mark in 2009, which we continue to hold. We take data protection and cyber security extremely seriously and hold both ISO 27001 and Cyber Essentials Plus which demonstrates we have defined and put in place best-practice information security processes. </p>");
                _NewContent.AppendLine("                <p>&nbsp;</p>");
                _NewContent.AppendLine("                <p>We are recognised by independent legal directories, The Legal 500 and Chambers and Partners, as a top tier firm, described as a “diligent and professional team that is prepared to go the extra mile for its clients”. As such, many of our cases have had a long lasting legal impact. </p>");
                _NewContent.AppendLine("                <p>&nbsp;</p>");
